...
router.get('/business/notifications', authMiddleware_1.authMiddleware, async (req, res) => {
    try {
        // Get the businessId from the authenticated user
        const businessId = req.user.businessId;
...
router.put('/business/notifications', authMiddleware_1.authMiddleware, async (req, res) => {
    try {
        // Get the businessId from the authenticated user
        const businessId = req.user.businessId;
        ...
        const updatedBusiness = await db_1.prisma.business.update({
            where: { id: businessId },
            data: {
