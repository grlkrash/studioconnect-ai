...
app.use('/admin/api/admin', admin_1.default);
app.use('/admin/api/clients', clientRoutes_1.default);
app.use('/admin/api/projects', projectRoutes_1.default);
app.use('/admin/api/knowledge-base', knowledgeBaseRoutes_1.default);
app.use('/admin/api/business', businessRoutes_1.default);
app.use('/admin/api/agent-config', agentConfigRoutes_1.default);
app.use('/admin/api/lead-questions', leadQuestionRoutes_1.default);
app.use('/admin/api/integrations', integrationRoutes_1.default);
app.use('/admin/api/calls', callHistoryRoutes_1.default);
app.use('/admin/api/interactions', interactionRoutes_1.default);
app.use('/admin/api/analytics', analyticsRoutes_1.default);
